...
class MovieDetailsViewController: UIViewController {
    ...
    private var movieSpecVC: MovieSpecViewController!
    ...
    @objc private func tapMyListButton(){
        ...
        func alertFunction(code: Int){
            ...
            let sucessAlert = UIAlertController(title: "Sucesso", message: "Filme adicionado a lista", preferredStyle: .alert)
            let failureAlert = UIAlertController(title: "Erro", message: "Verifique sua conexao e tente novamente mais tarde", preferredStyle: .alert)
    ...
    private func setupSegmentedControl() {
        ...
        segmentedControl = UISegmentedControl(items: ["ASSISTA TAMBEM", "DETALHES"])
        ...
        // MARK: SegmentedControl Underline
        ...
        // MARK: SegmentedControl constraints
    ...
    @objc func handleSegmentedControl () {
        ...
        switch segmentedControl.selectedSegmentIndex {
            case 0:
                ...
                movieSpecVC.view.isHidden = true
            
            case 1:
                recommendedVC.view.isHidden = true
                movieSpecVC.view.isHidden = false
    ...
    private func changeSegmentedControlUnderline () {
        ...
        //let teste = segmentedControl.widthForSegment(at: 1)
    
        UIView.animate(withDuration: 0.3) {
            self.segmentedControlUnderline.transform = CGAffineTransform(translationX: leftDistance, y: 0)
            //self.segmentedControlUnderline.transform = CGAffineTransform(scaleX: teste, y: 4)
            
            //self?.segmentedControlUnderline.leftAnchor.constraint(equalTo: self!.segmentedControl.leftAnchor, constant: leftDistance)
            //self?.segmentedControlUnderline.widthAnchor.constraint(equalToConstant: 50).isActive = true
    ...
    private func setupContainerView() {
        ...
        recommendedVC = RecommendedMoviesViewController(movieId: self.movieId)
        movieSpecVC = MovieSpecViewController(movie: self.movie)
        
        addChild(recommendedVC)
        addChild(movieSpecVC)
        
        scrollView.addSubview(recommendedVC.view)
        scrollView.addSubview(movieSpecVC.view)
        
        recommendedVC.didMove(toParent: self)
        movieSpecVC.didMove(toParent: self)
        
        movieSpecVC.view.translatesAutoresizingMaskIntoConstraints = false
        ...
        movieSpecVC.view.topAnchor.constraint(equalTo: segmentedControl.bottomAnchor, constant: 20).isActive = true
        movieSpecVC.view.trailingAnchor.constraint(equalTo: view.trailingAnchor).isActive = true
        movieSpecVC.view.leadingAnchor.constraint(equalTo: view.leadingAnchor).isActive = true
        movieSpecVC.view.bottomAnchor.constraint(equalTo: scrollView.bottomAnchor, constant: -20).isActive = true
